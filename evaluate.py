...
def evaluate(model_file_path, lable_feature_map_file_path, feature_extractors, input_file_path, prediction_output_file_path, eval_output_file_path):
    ...
    run(PREDICT_CMD + " -b 1 %s %s %s > %s" % (liblinear_file_path, model_file_path, prediction_output_file_path, eval_output_file_path))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prediction_output_file_path', help = 'prediction file that stores prediction details generated by liblinear')
    parser.add_argument('--eval_output_file_path', help = 'evaluation output file that stores the accuracy generated by liblinear')
    ...
    evaluate(args.model, args.map, feature_extractors, eval_input_file, args.prediction_output_file_path, args.eval_output_file_path)
